...
프리플랍 재레이즈의 최소 총액은 현재 베팅 레벨의 2배입니다. 이는 작은 폭의 연속 민레이즈가 4-bet·5-bet으로 누적되어 플레이와 AI 판단을 왜곡하지 않도록 둔 이 게임의 의도적인 커스텀 규칙입니다.
...
| **Cost · Short Stack Turbo** | 각 100칩 | 15 | R1–5 `0.5/1/A1` → R6–10 `1/2/A2` → R11–15 `2/4/A4` | 양쪽 모두 앤티 지불, 5라운드마다 상승하는 압축된 승부 |
